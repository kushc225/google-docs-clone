...
const ImageButton = () => {
  const { editor } = useEditorStore();
  const [isDialogOpen, setIsDiallogOpen] = useState(false);
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          <DropdownMenuItem onClick={() => setIsDiallogOpen(true)}>
            <SearchIcon className="size-4 mr-2" />
            Paste Image url
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
      <Dialog open={isDialogOpen} onOpenChange={setIsDiallogOpen}>
        <DialogContent>
          <DialogHeader>
