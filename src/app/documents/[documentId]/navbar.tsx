...
import RenameDialog from '@/components/rename-diaload';
import RemoveDialog from '@/components/remove-diaload';
...
export const Navbar = ({ data }: NavbarProps) => {
  ...
  return (
    <nav className="flex itemcenter justify-between">
          ...
          <div className="flex ">
            <Menubar className="border-none bg-transparent shadow-none h-auto p-0">
              ...
              <MenubarMenu>
                ...
                <MenubarContent>
                  <MenubarItem>
                    <Undo2Icon onClick={() => editor?.chain().focus().undo().run()} className="size-4 mr-2" />
